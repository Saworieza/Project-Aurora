...
class PayOthersControllerTest < ActionController::TestCase
  ...
  test "should create pay_other" do
    assert_difference('PayOther.count') do
      post :create, pay_other: { adm_no: @pay_other.adm_no, amount: @pay_other.amount, form: @pay_other.form, pay_method: @pay_other.pay_method, payment_for: @pay_other.payment_for, stream: @pay_other.stream, student_name: @pay_other.student_name }
    end
  ...
  test "should update pay_other" do
    patch :update, id: @pay_other, pay_other: { adm_no: @pay_other.adm_no, amount: @pay_other.amount, form: @pay_other.form, pay_method: @pay_other.pay_method, payment_for: @pay_other.payment_for, stream: @pay_other.stream, student_name: @pay_other.student_name }
    assert_redirected_to pay_other_path(assigns(:pay_other))
  end
